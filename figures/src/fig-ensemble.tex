...
\def\ycol{-1.16}   % Sammelschiene
\def\yens{-1.76}   % Mehrheitsbalken
...
\begin{scope}[on background layer]
  \draw[draw=black!38, dashed, rounded corners=8pt, line width=0.9pt,
        fill=black!2] (-5.85, 1.86) rectangle (5.85, -2.28);
\end{scope}
...
\foreach \bb/\xc/\clr in {bA/\cA/clrCls, bB/\cB/clrPrompt, bC/\cC/clrPCS}{
  ...
  \foreach \dx in {-\dchip, 0, \dchip}{
    ...
    \draw[bus]  ({\xc+\dx}, {\ychip-0.76}) -- ({\xc+\dx}, \ycol);
  }
  ...
  \node[inner sep=1.6pt, font=\fontsize{6.2}{7.6}\selectfont\itshape,
